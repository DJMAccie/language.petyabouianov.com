...
cp "$ROOT_DIR/studio-api.js" "$IOS_WEB_DIR/studio-api.js"
cp "$ROOT_DIR/studio-ui.js" "$IOS_WEB_DIR/studio-ui.js"
cp "$ROOT_DIR/studio-daily.js" "$IOS_WEB_DIR/studio-daily.js"
cp "$ROOT_DIR/studio-quiz.js" "$IOS_WEB_DIR/studio-quiz.js"
cp "$ROOT_DIR/studio-library.js" "$IOS_WEB_DIR/studio-library.js"
...
mkdir -p "$IOS_WEB_DIR/assets"
cp -R "$ROOT_DIR/assets/." "$IOS_WEB_DIR/assets/"
...
if ! grep -q 'ios-config.js' "$IOS_WEB_DIR/index.html"; then
...
if ! grep -q 'offlineSeedPaths' "$IOS_WEB_DIR/index.html"; then
